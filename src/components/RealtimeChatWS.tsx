...
import { useRealtimeApiWs } from '@/hooks/useRealtimeApiWS';
...
export function RealtimeChatWS() {
  ...
  function handleConnect() {
    if (isConnected) {
      ...
      setMessages(prev => [...prev, {
        id: generateId(),
        role: 'system',
        content: 'Connecting to Realtime API via WebSocket...',
        final: true
      }]);
      connect();
    }
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-3xl mx-auto">
      <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-t-lg">
        <h2 className="text-xl font-bold mb-2">Realtime Chat (WebSocket)</h2>
        ...
        <div className="mb-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md text-sm">
          <strong>Note:</strong> OpenAI's Realtime API is in beta and requires special access. This implementation uses WebSockets instead of WebRTC.
          <a 
