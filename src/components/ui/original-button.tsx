...
export interface OriginalButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'default' | 'ghost';
}

export const OriginalButton = React.forwardRef<HTMLButtonElement, OriginalButtonProps>(
...
OriginalButton.displayName = 'OriginalButton'; 