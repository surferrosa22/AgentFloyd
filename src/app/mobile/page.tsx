...
import { Home, Mail, CreditCard, ArrowRight, Settings } from 'lucide-react';
  ...
  return (
    <div className={
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Link href="/mobile" className="p-2">
              <Home size={20} className={resolvedTheme === 'dark' ? 'text-white' : 'text-black'} />
            </Link>
      ...
      <main className="relative z-10 pt-6 pb-6 w-full px-4 flex-grow flex flex-col justify-center">
        <div className="flex flex-col items-center text-center mt-10 mb-16">
          ...
          <div className="flex flex-col gap-3 w-full max-w-xs">
            <button
              ...
              className="w-full px-5 py-3 rounded-full bg-white text-black font-semibold flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all"
            >
        ...
        <div className={`rounded-2xl p-5 mb-6 ${resolvedTheme === 'dark' ? 'bg-white/5' : 'bg-black/5'}`}>
          <h2 className={`text-xl font-semibold mb-3 ${resolvedTheme === 'dark' ? 'text-white' : 'text-black'}`}>
            What can Floyd do?
          </h2>
          <ul className={`space-y-2 ${resolvedTheme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
